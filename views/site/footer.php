...
<footer class="footer">
    <div class="container">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="<?php echo base_url(); ?>" style="pointer-events: none;padding: 10px;background-color: white"><img src="<?php echo base_url(); ?>upload/logo6.jpg" alt="" class="img-responsive"></a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">q
                <div class="footer__copyright__text">
                    ...
                    <p>Copyright ©
                        ...
                        Cảm ơn đã ghé với shop<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" >Nhóm  8 - JUNO </a>
                    </p>
